...
def full_processing_task(channel_id: int):
    ...
    if channel.last_active is not None and channel.last_active > datetime.now() - timedelta(minutes=30):
        logger.info("Channel was active less than 30 minutes ago, skipping", extra={"channel_id": channel_id})
        return
    logger.info("Channel was active more than 30 minutes ago, processing", extra={"channel_id": channel_id})
