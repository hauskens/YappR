...
def search(search_term: str, broadcaster_id: int) -> tuple[set[Segments], set[Video]]:
    ...
    segment_result: set[Segments] = set()
    if channels is None:
        ...
        for wordmap in search_result:
            ...
            for segment in segments:
                ...
                if word_index == 0:
                    ...
                    first_segment = adjasent_segment
                ...
                if search_words_present_in_sentence(current_sentence, search_words[1:]):
                    segment_result.add(first_segment)
