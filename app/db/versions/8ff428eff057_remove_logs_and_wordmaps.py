...
def downgrade() -> None:
    ...
    sa.Column('accepted_by', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['accepted_by'], ['users.id'], name='user_invite_accepted_by_fkey'),
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], name='user_invite_owner_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='user_invite_pkey')
    )
