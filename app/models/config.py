...
class Config:
    def __init__(self):
        ...
        self.bot_discord_enabled: bool = os.environ.get("BOT_DISCORD_ENABLED", "false").lower() == "true"
        self.bot_discord_admin_guild: int | None = os.environ.get("BOT_DISCORD_ADMIN_GUILD")
        self.bot_twitch_enabled: bool = os.environ.get("BOT_TWITCH_ENABLED", "false").lower() == "true"
